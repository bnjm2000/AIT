...
class FinanceFeatureTests(unittest.TestCase):
    ...
    def test_uom_menu_and_add_item_reset_behaviour(self):
        ...
        self.assertIn('function financeAddContainerAsGroup(', source)
        self.assertIn('categoryOverride = financeAddDepartmentOverride()', source)
        self.assertIn('groupTitle: containerId', source)
        self.assertIn("financeLineGroupState.title = selected.containerId", source)
        self.assertIn('function financeContainerMajorityCategory(', source)
    ...
    def test_quotation_ui_has_no_native_selects(self):
        ...
        self.assertIn('financedaysleft(document.paymentduedate)', source)
        self.assertIn('financepaymentcountdowntext(document)', source)
