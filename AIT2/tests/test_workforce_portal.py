...
class WorkforcePortalTests(unittest.TestCase):
    ...
    def test_worker_period_schedule_pdf_includes_all_events_rooms_and_optional_rates(self):
        ...
        for expected in (
            "WORKER SCHEDULE", "陈伟 Chen Wei", "143 - Test Production", "10 Jul 2026",
            ...
            "12 Jul 2026", "Backline support", "Service", "$1,500.00/service",
            "16 Jul 2026", "3 pax manpower", "Manpower", "$180.00/pax/day",
        ):
    ...
    def test_event_report_pdf_contains_assets_manpower_vendor_services_and_transport(self):
        ...
        for expected in (
            ...
            "Test Brand Test Console Audio requirement", "AU#01 (prepared)",
    ...
    def test_event_report_reconciles_bulk_preparation_with_model_requirement(self):
        ...
        self.assertIn("AU-BULK × 5 (prepared)", rows[0]["assetIds"])
