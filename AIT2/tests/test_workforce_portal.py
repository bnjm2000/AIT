...
class WorkforcePortalTests(unittest.TestCase):
    ...
    def test_worker_period_schedule_pdf_includes_all_events_rooms_and_optional_rates(self):
        ...
        response = self.client.get(
            ...
            "?startDate=2026-07-01&endDate=2026-07-31&showRates=1"
        )
        ...
        for expected in (
            "WORKER SCHEDULE", "陈伟 Chen Wei", "Test Production", "#143",
            "Test Venue", "第二场活动", "#144", "Room Venue", "Hall B", "Audio Engineer",
